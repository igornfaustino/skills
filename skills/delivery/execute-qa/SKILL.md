...
2. Read the PRD at `./docs/tasks/[timestamp]-prd-[feature-slug]/prd.md` and extract ALL numbered functional requirements.
3. Read the Tech Spec at `./docs/tasks/[timestamp]-prd-[feature-slug]/techspec.md` and verify implemented technical decisions.
4. Read Tasks at `./docs/tasks/[timestamp]-prd-[feature-slug]/tasks.md` and verify completion status of each task.
5. Create a verification checklist based on the requirements.
6. Do NOT skip this step — understanding requirements is fundamental for QA.
...
2. Save bugs to `./docs/tasks/[timestamp]-prd-[feature-slug]/bugs.md`.
