...
2. Verify the PRD exists at `tasks/[timestamp]-prd-[feature-slug]/prd.md`. If missing, halt and report.
...
1. Save to: `tasks/[timestamp]-prd-[feature-slug]/techspec.md`.
...
- [ ] File written to `./docs/tasks/[timestamp]-prd-[feature-slug]/techspec.md`.
