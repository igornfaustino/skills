...
2. Read the task definition file at `./tasks/[timestamp]-prd-[feature-slug]/[num]_task.md`.
3. Read the PRD at `./tasks/[timestamp]-prd-[feature-slug]/prd.md` for context.
4. Read the Tech Spec at `./tasks/[timestamp]-prd-[feature-slug]/techspec.md` for technical requirements.
