...
2. Read the task definition file at `./docs/tasks/[timestamp]-prd-[feature-slug]/[num]_task.md`.
3. Read the PRD at `./docs/tasks/[timestamp]-prd-[feature-slug]/prd.md` for context.
4. Read the Tech Spec at `./docs/tasks/[timestamp]-prd-[feature-slug]/techspec.md` for technical requirements.
5. Identify dependencies from previous tasks and verify they are complete.
6. Do NOT skip any of these reads.
