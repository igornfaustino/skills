...
2. Verify the PRD exists at `tasks/[timestamp]-prd-[feature-slug]/prd.md`. If missing, halt.
3. Verify the Tech Spec exists at `tasks/[timestamp]-prd-[feature-slug]/techspec.md`. If missing, halt.
...
3. Create the summary file: `./tasks/[timestamp]-prd-[feature-slug]/tasks.md`.
4. Create individual task files: `./tasks/[timestamp]-prd-[feature-slug]/[num]_task.md`.
...
- [ ] Files saved to `./tasks/[timestamp]-prd-[feature-slug]/`.
