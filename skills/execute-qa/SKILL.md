...
2. Read the PRD at `./tasks/[timestamp]-prd-[feature-slug]/prd.md` and extract ALL numbered functional requirements.
3. Read the Tech Spec at `./tasks/[timestamp]-prd-[feature-slug]/techspec.md` and verify implemented technical decisions.
4. Read Tasks at `./tasks/[timestamp]-prd-[feature-slug]/tasks.md` and verify completion status of each task.
...
2. Save bugs to `./tasks/[timestamp]-prd-[feature-slug]/bugs.md`.
