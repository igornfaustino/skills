...
4. Use the output directory pattern: `./tasks/[timestamp]-prd-[feature-slug]/`.
...
1. Create the directory: `./tasks/[timestamp]-prd-[feature-slug]/`.
2. Save the PRD to: `./tasks/[timestamp]-prd-[feature-slug]/prd.md`.
...
- [ ] File saved to `./tasks/[timestamp]-prd-[feature-slug]/prd.md`.
- [ ] Final path provided.
