...
2. Derive the feature slug in kebab-case.
3. Generate a creation timestamp in the format `YYYYMMDDHHmmss`.
4. Use the output directory pattern: `./docs/tasks/[timestamp]-prd-[feature-slug]/`.
...
1. Create the directory: `./docs//tasks/[timestamp]-prd-[feature-slug]/`.
2. Save the PRD to: `./docs//tasks/[timestamp]-prd-[feature-slug]/prd.md`.
...
- [ ] File saved to `./docs/tasks/[timestamp]-prd-[feature-slug]/prd.md`.
- [ ] Final path provided.
